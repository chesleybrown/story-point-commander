...
export class StoryPointSolutionEffortOptions {
  static Brief1: StoryPointDetail = {
    ...
    description: (
      <span>
        <strong>Insignificant</strong>, one line change; typo
      </span>
    ),
  };
  static Brief2: StoryPointDetail = {
    ...
    description: (
      <span>
        <strong>Minor</strong> change; configuration updates
      </span>
    ),
  };
  static Brief3: StoryPointDetail = {
    ...
    description: (
      <span>
        <strong>Small</strong>, scoped feature; requires{" "}
        <strong>insignificant</strong> research or cross-team coordination
      </span>
    ),
  };
  static Brief5: StoryPointDetail = {
    ...
    description: (
      <span>
        <strong>Complex</strong> feature; requires <strong>little</strong>{" "}
        research or cross-team coordination
      </span>
    ),
  };
  static Brief8: StoryPointDetail = {
    ...
    description: (
      <span>
        <strong>Large</strong>, complex feature; requires <strong>some</strong>{" "}
        research or cross-team coordination
      </span>
    ),
  };
  static Brief13: StoryPointDetail = {
    ...
    description: (
      <span>
        <strong>Very large</strong>, complex feature; requires{" "}
        <strong>significant</strong> research or cross-team coordination
      </span>
    ),
  };
  static Solution1: StoryPointDetail = {
    ...
    description: (
      <span>
        Obvious; <strong>zero</strong> unknowns
      </span>
    ),
  };
  static Solution2: StoryPointDetail = {
    ...
    description: (
      <span>
        Known; <strong>little to zero</strong> unknowns
      </span>
    ),
  };
  static Solution3: StoryPointDetail = {
    ...
    description: (
      <span>
        Generally known; <strong>few</strong> unknowns
      </span>
    ),
  };
  static Solution5: StoryPointDetail = {
    ...
    description: (
      <span>
        Have an idea; <strong>research limited</strong> to known unknowns
      </span>
    ),
  };
  static Solution8: StoryPointDetail = {
    ...
    description: (
      <span>
        Concept and the goals <strong>understood</strong>; solution requires{" "}
        <strong>some research</strong> that can only be done as part of the work
      </span>
    ),
  };
  static Solution13: StoryPointDetail = {
    ...
    description: (
      <span>
        Concept and the goals <strong>understood</strong>; solution requires{" "}
        <strong>significant research</strong> that can only be done as part of
        the work
      </span>
    ),
  };
  static Effort1: StoryPointDetail = {
    ...
    description: (
      <span>
        <strong>Simplistic</strong>; I could do many of these in a day
      </span>
    ),
  };
  static Effort2: StoryPointDetail = {
    ...
    description: (
      <span>
        Pretty <strong>easy</strong>, sanity check level code review
      </span>
    ),
  };
  static Effort3: StoryPointDetail = {
    ...
    description: (
      <span>
        Will have to <strong>focus</strong>, requires meaningful{" "}
        <strong>code review and tests</strong>, needs <strong>one</strong>{" "}
        session of concentration
      </span>
    ),
  };
  static Effort5: StoryPointDetail = {
    ...
    description: (
      <span>
        Complexity or amount of work to be done requires a{" "}
        <strong>couple</strong> sessions of concentration
      </span>
    ),
  };
  static Effort8: StoryPointDetail = {
    ...
    description: (
      <span>
        Complexity or amount of work to be done requires a <strong>few</strong>{" "}
...
export class StoryPointTestingOptions {
  static TestingBaseline: StoryPointDetail = {
    ...
    description: (
      <span>
        <strong>Zero</strong> additional testing effort beyond standard practice
      </span>
    ),
  };
  static TestingPlus1: StoryPointDetail = {
    ...
    description: (
      <span>
        Testing effort <strong>exceeds standard practice</strong> and is{" "}
        <strong>equal</strong> to the effort of the implementation
      </span>
    ),
  };
  static TestingPlus2: StoryPointDetail = {
    ...
    description: (
      <span>
        Testing effort <strong>exceeds standard practice</strong> and is{" "}
        <strong>greater</strong> than the effort of the implementation
      </span>
    ),
  };
}
...
export class StoryPointRiskOptions {
  static RiskBaseline: StoryPointDetail = {
    ...
    description: (
      <span>
        All risks <strong>owned</strong> outside of this ticket,{" "}
        <strong>accepted</strong>, <strong>resolved</strong>, or{" "}
  ...
  static RiskPlus1: StoryPointDetail = {
    ...
    description: (
      <span>
        <strong>Low to moderate</strong> risk <strong>owned</strong> and{" "}
        <strong>accepted</strong> as part of this ticket
      </span>
    ),
  };
  static RiskPlus2: StoryPointDetail = {
    ...
    description: (
      <span>
        <strong>Moderate to high</strong> risk <strong>owned</strong> and{" "}
        <strong>accepted</strong> as part of this ticket
      </span>
    ),
  };
