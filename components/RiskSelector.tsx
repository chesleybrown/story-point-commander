                  ...
                  <Row>
                    <Col xs={12} sm={4}>
                      <SelectableCard
                        ...
                        option={StoryPointRiskOptions.RiskBaseline}
                        current={StoryPointRiskOptions[d.value.riskOptionId]}
                      ></SelectableCard>
                    </Col>
                    <Col xs={12} sm={4}>
                      <SelectableCard
                        ...
                        option={StoryPointRiskOptions.RiskPlus1}
                        current={StoryPointRiskOptions[d.value.riskOptionId]}
                      ></SelectableCard>
                    </Col>
                    <Col xs={12} sm={4}>
                      <SelectableCard
                        ...
                        option={StoryPointRiskOptions.RiskPlus2}
                        current={StoryPointRiskOptions[d.value.riskOptionId]}
                      ></SelectableCard>
                    </Col>
                  </Row>
